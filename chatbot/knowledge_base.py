...
RESPONSE_KEYS_MAP_SAMANVAY_OFFICER = {
    ...
    'send_proposal_document_to_collector_for_extend_date' : {
       'en' : 'Go to section 19 time extension and click on send to collector for extend date button.',
       'hi' : 'धारा 19 की घोषणा के लिए अवधि बढ़ाना पर जाएं और तारीख बढ़ाने के लिए कलेक्टर विभाग को भेजे  बटन पर क्लिक करें।',
       'mr' : 'कलम 19 ची घोषणा करीता मुदत वाढवणे वर जा आणि दिनांक वाढवण्यासाठी जिल्हाधिकारी विभागाकडे पाठवा बटणावर क्लिक करा.'
    },

    'section_19' : {
        'en' : 'Go to Declaration of Article 19 so section 19 will open so you can send it to Respected.Collector.',
        'hi' : 'धारा 19 की घोषणा पर जाएं ताकि धारा 19 खुल जाए और आप उसे सम्मानित कलेक्टर को भेज सकें।',
        'mr' : 'कलम 19 ची घोषणा करीता धारा 19 उघडेल जेणेकरून तुम्ही ते सम्मानित कलेक्टर कडे पाठवू शकता.'
    },

    'section_19_covering_letter' : {
        'en' : 'Go to Declaration of Article 19 and click on कलम 19 मान्यता so Section 19 Covering Letter will open.',
        'hi' : 'धारा 19 की घोषणा पर जाएं और कलम 19 मान्यता पर क्लिक करें, जिससे धारा 19 आवरण पत्र खुल जाएगा।',
        'mr' : 'कलम 19 ची घोषणा वर जा आणि कलम 19 मान्यता वर क्लिक करा म्हणजे कलम 19 मान्यता उघडेल.'
    }
}
